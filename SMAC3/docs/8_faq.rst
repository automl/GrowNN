...
Should I use SMAC2 or SMAC3?
  ...
  General Algorithm Configuration <https://ml.informatik.uni-freiburg.de/wp-content/uploads/papers/11-LION5-SMAC.pdf>`_, ### et al., 2021). However, the reimplementation slightly differs from the original
