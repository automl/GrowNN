...
#SBATCH --job-name=ssh_gpu4.kisski
#SBATCH --cpus-per-task=1
#SBATCH --mem=2GB
#SBATCH --output=ssh_files/kissi/result_on_gpu4.kisski.out
#SBATCH --error=ssh_files/kissi/error_on_gpu4.kisski.err
#SBATCH --time=72:00:00
#SBATCH --nodelist=gpu004.kisski
