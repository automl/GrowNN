...
#SBATCH --job-name=ssh_gpu6.kisski
#SBATCH --cpus-per-task=1
#SBATCH --mem=2GB
#SBATCH --output=ssh_files/kissi/result_on_gpu6.kisski.out
#SBATCH --error=ssh_files/kissi/error_on_gpu6.kisski.err
#SBATCH --time=24:00:00
#SBATCH --nodelist=gpu006.kisski
