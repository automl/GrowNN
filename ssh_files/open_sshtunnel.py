...
if __name__ == "__main__":
    ...
    if "bigwork" in os.getcwd():
        ...
        experimenter = PyExperimenter("//mnt/home/lfehring/MasterThesis/architectures-in-rl/baselines/blackbox_joined_hpo_nn/config/blackbox_joined_hpo_nn.yaml", use_ssh_tunnel=True, use_codecarbon=False)
