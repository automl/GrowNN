...
if __name__ == "__main__":
    ...
    if "bigwork" in os.getcwd():
        ...
        experimenter = PyExperimenter("/mnt/home/lfehring/MasterThesis/architectures-in-rl/baselines/blackbox_only_hpo/config/blackbox_only_hpo.yaml", use_ssh_tunnel=True, use_codecarbon=False)
